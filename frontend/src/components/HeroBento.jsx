      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-gradient-to-br from-emerald-100/80 to-teal-50/60 rounded-[2rem] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between overflow-hidden relative group min-h-[350px] md:min-h-[420px] shadow-xs">
          ...
          <div className="flex flex-col text-left space-y-3 md:max-w-[50%] z-10">
            ...
            <p className="text-slate-500 text-xs md:text-sm leading-relaxed max-w-[90%] font-medium">
              Discover unique quality pieces designed for your everyday rhythm and distinct lifestyle.
            </p>
            <div className="pt-2">
              <Link 
        ...
        >
          <div className="z-10">
            ...
            <p className="text-slate-400 text-[10px] font-bold tracking-wide mt-1 uppercase">Curated Junior Lineup</p>
          </div>
        ...
        >
          <div className="z-10">
            <h3 className="text-base font-extrabold text-slate-800 tracking-tight">Luxury</h3>
            <h3 className="text-base font-extrabold text-slate-800 tracking-tight">Eyewear</h3>
          </div>
        ...
        >
          <div className="z-10">
            <h3 className="text-base font-extrabold text-slate-800 tracking-tight">Iconic</h3>
            <h3 className="text-base font-extrabold text-slate-800 tracking-tight">Footwear</h3>
          </div>
